...
export function renderResolutionHtml(p) {
...
export async function generatePdfToFile({ html, outPath, options, }) {
    const { format = "A4", margin = { top: "20mm", right: "18mm", bottom: "20mm", left: "18mm" }, printBackground = true, args = ["--no-sandbox", "--font-render-hinting=medium"], } = options ?? {};
...
export async function generateResolutionPdfFile(payload, outPath) {
